...
class PieChartViewController : UIViewController {
  ...
  override func viewDidLoad() {
    ...
    pieChartView.segments = [
      LabelledSegment(color: #colorLiteral(red: 1.0, green: 0.121568627, blue: 0.28627451, alpha: 1.0), name: "",  value: 10),    //Red -
      LabelledSegment(color: #colorLiteral(red: 1, green: 0.541176471, blue: 0, alpha: 1), name: "",  value: 30),    //Orange
      LabelledSegment(color: #colorLiteral(red: 0.5791940689, green: 0.1280144453, blue: 0.5726861358, alpha: 1), name: "",  value: 27),    //Purple
      LabelledSegment(color: #colorLiteral(red: 0.0, green: 0.870588235, blue: 1.0, alpha: 1.0), name: "",  value: 40),    //Light Blue
      LabelledSegment(color: #colorLiteral(red: 0.9994240403, green: 0.9855536819, blue: 0, alpha: 1), name: "",  value: 25),    //Green
      LabelledSegment(color: #colorLiteral(red: 0.0, green: 0.392156863, blue: 1.0, alpha: 1.0), name: "",  value: 38)     //Blue
    ]
